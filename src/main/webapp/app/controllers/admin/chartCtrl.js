...
happySurvey.controller('chartCtrl', ['$scope', '$http', function ($scope, $http){
	...
	for ( var i = 0; i < results.gruppen[0].fragen[0].AverageValue.length; i++ ) {

		$scope.data.push( { label: results.gruppen[0].fragen[0].AverageValue[i].text, y: results.gruppen[0].fragen[0].AverageValue[i].count } );
